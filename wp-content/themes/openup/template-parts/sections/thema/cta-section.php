<?php
$cta_text = get_field('thema_section_title');
$cta_link = get_field('thema_section_link');
$cta_section_color = get_field('thema_section_color');
$title_color = get_field('thema_title_color');
$wave_color = get_field('thema_wave_color');
        ...
        <div class="row">
            <div class="col-12">
                <div class="s-team-cta__content d-flex flex-column flex-lg-row  justify-content-lg-between align-items-start align-items-lg-center">
                    ...
                    <?php endif; ?>
                    <?php if ($cta_link):?>
                        <a class="c-btn c-btn-primary--blue c-btn-primary--arrow" href="<?php echo $cta_link['url']?>"><?php echo $cta_link['title']?>
                            <svg class="icon">
