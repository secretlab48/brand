...
//ACF fields
$intro_text = get_field('sections_intro_text_mkb','option');
$section_bg_color = get_field('sections_bg_color_mkb','option');
$intro_text_color = get_field('sections_intro_text_color_mkb','option');
$section_link = get_field('sections_link_mkb','option');
...
<section class="s-logo-banner <?php if(empty($section_bg_color)): echo 'u-bg-secondary-skin'; else: echo ''; endif; ?>"
    ...
    <a class="s-logo-banner__link JS-check-href" href="<?php echo $section_link['url']; ?>">
        <div class="container">
            <div class="row">
                <div class="col-12 d-flex flex-column flex-md-row align-items-center justify-content-center justify-content-md-between JS-logo-direction">
                    ...
                    <?php if (have_rows('logos_sections_mkb','option')): ?>
                        <div class="row w-100 d-flex flex-md-nowrap justify-content-md-between align-items-center">
                            <?php while (have_rows('logos_sections_mkb','option')): the_row();
                                $logo_image = get_sub_field('item_logo_image_mkb','option'); ?>
