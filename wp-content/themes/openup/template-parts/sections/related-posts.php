            ...
            <div class="row">
                <div class="col-12">
                    <div class="c-intro text-center">
                        <h2 class="c-intro__title u-color-primary-dark-blue"><?php _e('Lees ook deze artikelen', 'openup'); ?></h2>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-12 p-0">
                    <div class="c-slider">
                        <div class="c-slider--mobile d-md-none">
                        ...
                        <div class="c-slider--desctop d-none d-md-block">
                            <div class="swiper-container">
                                <div class="swiper-wrapper">
                                    <?php foreach ($related_posts as $post) :
                                        setup_postdata($post);
