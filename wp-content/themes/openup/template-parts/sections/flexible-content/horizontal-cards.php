                    ...
                    <div class="row">
                        <div class="col-12 col-md-6 order-2 order-md-1 align-self-center">
                            ...
                            <?php if ( $images_layout == 2 && ! empty( $anchor ) ) : ?>
                                <a class="job-board-btn anchor-btn c-btn c-btn-primary--<?php echo $cards_button_color; ?>" href="#department-<?php echo strtolower( str_replace( ' ', '-', $anchor ) ); ?>"><?php echo __( 'Department vacancies', 'openup' ); ?></a>
                            <?php endif; ?>
                        </div>
