...
<section class="s-media u-bg-secondary-skin">
    ...
    <?php if ($media_section_link) : ?>
        <div class="s-media__btn d-flex justify-content-center">
            <a href="<?php echo $media_section_link['url']; ?>" class="c-btn c-btn-primary--dark-blue">
    ...
    <?php if ($media_section_image) : ?>
        <div class="s-media__img">
            <img src="<?php echo $media_section_image['url']; ?>" alt="<?php echo $media_section_image['alt']; ?>">
        </div>
    <?php endif; ?>
</section>
