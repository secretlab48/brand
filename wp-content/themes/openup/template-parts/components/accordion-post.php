...
$content = get_field('content_editor_faq');
$add_link_list = get_field('add_link_list');
$link_list_faq = get_field('link_list_faq');
$add_image_faq = get_field('add_image_faq');
$image_faq = get_field('image_faq');
?>
<div class="c-accordion__card JS-accordion">
