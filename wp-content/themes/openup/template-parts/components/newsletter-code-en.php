...
<form method="POST" action="https://open-up.activehosted.com/proc.php" id="_form_29_"
      class="_form _form_29 _inline-form  _dark JS-form" novalidate>
    ...
    <div class="_form-content">
        ...
        <div class="_form_element _form_element_input _x82668303 _full_width ">
            ...
            <label class="_form-label">
             <?php _e("Full name/Nickname", 'openup')?>
            </label>
        </div>
